...
public class Scene {
	...
	private List<Vector3D> lightPos;
	private List<Color> lightColours;

	public Scene(List<Polygon> polygons, Vector3D lightPos) {
          this.polygons = polygons;
          this.lightPos = new ArrayList<>();
          this.lightPos.add(lightPos);
          this.lightColours = new ArrayList<>();
          this.lightColours.add(Color.WHITE);
	}

	public Scene(List<Polygon> polygons, List<Vector3D> lightPos, List<Color> lightColours) {
		this.polygons = polygons;
		this.lightPos = lightPos;
		this.lightColours = lightColours;
	}

	public void addLight(Vector3D lightpos, Color color){
		this.lightPos.add(lightpos);
		this.lightColours.add(color);
	}

	public void removeLight(){
		this.lightPos.remove(lightPos.size() - 1);
		this.lightColours.remove(lightColours.size() - 1);
	}
	...
	public List<Color> getLightColours() {
		return lightColours;
	}
