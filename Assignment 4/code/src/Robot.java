...
public class Robot {
	...
	private VariableTreeNode rootVariables;
	private Map<BlockNode, VariableTreeNode> variableBlockMapping = new HashMap<>();

	private VariableTreeNode currentScope;

	public void setRootVariable(VariableTreeNode treeNode){
		this.rootVariables = treeNode;
		this.variableBlockMapping.put(null, treeNode);
		this.currentScope = rootVariables;
	}
	...
	public void addScope(VariableTreeNode node){
		node.setParent(currentScope);
		this.currentScope.addChild(node);
	...
	public void setVariable(VariableNode key, int value){
		this.currentScope.setVariable(key, value);
	}
