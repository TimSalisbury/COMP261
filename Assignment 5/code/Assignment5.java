		...
		searchField.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				if(bruteForce.isSelected()){
					...
					JOptionPane.showMessageDialog(frame, "Brute Force took " + (System.currentTimeMillis() - start) + "ms");
				}else{
					double start = System.currentTimeMillis();
					index = new KMP(pattern, text).search(pattern, text);
					JOptionPane.showMessageDialog(frame, "KMP took " + (System.currentTimeMillis() - start) + "ms");
				}
